...
/**
 * Implementation of compare and set based on select2 protocol
 */
public class MaySet2 {
	...
	*/
    ...
    /**
     * set the value to the given new one if the value is the expected one
     *
     * @param newValue the new value to set
     * @return the result of the operation: true if succeeded false otherwise
     */
	public boolean maySet(int newValue){
